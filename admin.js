const scriptURL = "https://script.google.com/macros/s/AKfycbwsLxEq278ODYt8GeFH-V5yTOE73cgPQ0WgSgIiJft2PM9bRm6HpYQ17APFVDTD8ww8yA/exec";
...
function createCardHTML(d, index, type, currentStatus, isCompact = false) {
    ...
    // 🔥 FIX: Added ${paidNumHtml} below ${waSelectorHTML}
    return `
